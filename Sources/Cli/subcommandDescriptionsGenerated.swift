...
let subcommandDescriptions = [
    ...
    ["  command-palette", "Open the searchable command palette"],
    ...
    ["  overview", "Open the visual workspace and window overview"],
    ...
    ["  scratchpad", "Assign and toggle floating scratchpad windows"],
